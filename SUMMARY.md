...
* [API Reference](reference/api-reference/README.md)
  * [User API](reference/api-reference/user-api/README.md)
    * [Login](reference/api-reference/user-api/login.md)
    * [Logout](reference/api-reference/user-api/logout.md)
  ...
  * [Place API](reference/api-reference/place-api/README.md)
    * [Get Recommended Places](reference/api-reference/place-api/get-recommended-places.md)
  * [Trip Plan API](reference/api-reference/trip-plan-api/README.md)
    ...
    * [Create an One-Day Trip Plan](reference/api-reference/trip-plan-api/create-an-one-day-trip-plan.md)
    * [Update an One-Day Trip Plan](reference/api-reference/trip-plan-api/update-an-one-day-trip-plan.md)
